...
def parse_args():
    ...
    # ========================= Data Configs ==========================
    parser.add_argument('--train_annotation', type=str, default='labeled.json')
    parser.add_argument('--test_annotation', type=str, default='test_a.json')
    parser.add_argument('--train_zip_feats', type=str, default='labeled.zip')
    parser.add_argument('--test_zip_feats', type=str, default='test_a.zip')
