...
def parse_args():
    ...
    # ========================= Data Configs ==========================
    parser.add_argument('--train_annotation', type=str, default='/kaggle/input/challegemain/labeled.json')
    parser.add_argument('--test_annotation', type=str, default='/kaggle/input/challegemain/test_a.json')
    parser.add_argument('--train_zip_feats', type=str, default='/kaggle/input/challegemain/labeled.zip')
    parser.add_argument('--test_zip_feats', type=str, default='/kaggle/input/challegemain/test_a.zip')
